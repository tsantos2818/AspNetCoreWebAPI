        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Oliveira","1616196595"),
                    new Professor(2, 2, "Roberto", "Soares","6666666666"),
                    new Professor(3, 3, "Ronaldo", "Marconi","5858558558"),
                    new Professor(4, 4, "Rodrigo", "Carvalho","4444444444"),
                    new Professor(5, 5, "Alexandre", "Montanha", "9595959954"),
                });
